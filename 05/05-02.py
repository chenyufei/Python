...
if __name__ == '__main__':
    ...
    '''            *****************************************
            ...
            **      @author: Leon Wong             **
            *****************************************'''
    pageNo = input("Input the page number you want to scratch (1-100),please input 'quit' if you want to quit>")
    while not pageNo.isdigit() or int(pageNo) > 100:
        if pageNo == 'quit': quitit()
        print("Param is invalid , please try again.")
        pageNo = input("Input the page number you want to scratch >")
